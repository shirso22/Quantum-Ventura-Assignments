...
def fun_reflection(x,Qabs):
    ...
    #This is our objective function, with a global minima at Rs=1 and Rp=0, the closer it is to -1 the better our solution is
...
def fun_nlopt(x,gradn):
    ...
    print('Step = ',ctrl,', Objective Function value = ',y)
    ctrl += 1
    return fun(x)
